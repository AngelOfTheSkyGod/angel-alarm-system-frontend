...
export const initializeAASData = () :AASData => {
    return {
        ...
        alarmData: [{
            ...
            {time:"6:05am", days: ["M", "T", "W"], description: "go to gym", key:12, sound:"default timbre"},
            {time:"6:04am", days: ["M", "T", "W"], description: "go to gym", key:13, sound:"default timbre"},
            {time:"5:34am", days: ["M", "T", "W"], description: "go to gym", key:14, sound:"default timbre"}
        ]
    }
}